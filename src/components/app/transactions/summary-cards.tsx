        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
             ...
             <Card>
                ...
                <CardContent>
                    <div className={`text-3xl font-bold ${currentSummary.net >= 0 ? 'text-blue-600' : 'text-orange-500'}`}>{formatCurrency(currentSummary.net)}</div>
                    <Badge variant={currentSummary.net >= 0 ? 'default' : 'destructive'} className={`${currentSummary.net >= 0 ? 'bg-blue-100 text-blue-800' : 'bg-orange-100 text-orange-800'} text-xs font-normal`}>
